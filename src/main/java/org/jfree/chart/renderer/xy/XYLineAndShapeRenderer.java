...
public class XYLineAndShapeRenderer extends AbstractXYItemRenderer
            ...
            if (shape.intersects(dataArea)) {
                if (getItemShapeFilled(series, item)) {
                    if (this.useFillPaint) {
                        g2.setPaint(getPaint().getItemFillPaint(series, item));
                    }
                    else {
                        g2.setPaint(getPaint().getItemPaint(series, item));
                    }
    ...
    public LegendItem getLegendItem(int datasetIndex, int series) {
        ...
        Paint fillPaint = (this.useFillPaint ? getPaint().lookupSeriesFillPaint(series)
                : getPaint().lookupSeriesPaint(series));
